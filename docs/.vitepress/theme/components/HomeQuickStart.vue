...
const installMacCommand = 'curl -fsSL https://code.kimi.com/nighthawk/install.sh | bash'
const installWinCommand = 'irm https://code.kimi.com/nighthawk/install.ps1 | iex'
