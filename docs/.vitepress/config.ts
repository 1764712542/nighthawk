...
const config = withMermaid(defineConfig({
  base,
  title: 'NightHawk CLI Docs',
  description: 'NightHawk CLI Documentation',
  ...
  locales: {
    zh: {
      ...
      lang: 'zh-CN',
      link: '/zh/',
      title: 'NightHawk CLI 文档',
      description: 'NightHawk CLI 用户文档',
      themeConfig: {
        nav: [
          ...
          { text: '参考手册', link: '/zh/reference/nighthawk-command', activeMatch: '/zh/reference/' },
          ...
          '/zh/guides/': [
            {
              ...
              items: [
                ...
                { text: '从 legacy-cli 迁移', link: '/zh/guides/migration' },
                ...
                { text: '渗透测试模式', link: '/zh/guides/pentest-mode' },
          ...
          '/zh/reference/': [
            {
              text: '参考手册',
              items: [
                { text: 'nighthawk 命令', link: '/zh/reference/nighthawk-command' },
                { text: 'nighthawk acp 子命令', link: '/zh/reference/nighthawk-acp' },
                { text: '服务 API', link: '/zh/reference/server-api' },
                { text: '内置工具', link: '/zh/reference/tools' },
                { text: '斜杠命令', link: '/zh/reference/slash-commands' },
                { text: 'AgentSwarm 集群', link: '/zh/reference/agent-swarm' },
    ...
    en: {
      ...
      link: '/en/',
      title: 'NightHawk CLI Docs',
      description: 'NightHawk CLI User Documentation',
      themeConfig: {
        nav: [
          ...
          { text: 'Reference', link: '/en/reference/nighthawk-command', activeMatch: '/en/reference/' },
          ...
          '/en/guides/': [
            {
              ...
              items: [
                ...
                { text: 'Migrating from legacy-cli', link: '/en/guides/migration' },
                ...
                { text: 'Pentest Mode', link: '/en/guides/pentest-mode' },
          ...
          '/en/reference/': [
            {
              text: 'Reference',
              items: [
                { text: 'nighthawk Command', link: '/en/reference/nighthawk-command' },
                { text: 'nighthawk acp Subcommand', link: '/en/reference/nighthawk-acp' },
                ...
                { text: 'AgentSwarm Cluster', link: '/en/reference/agent-swarm' },
