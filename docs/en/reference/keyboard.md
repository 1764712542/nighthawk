...
| `Ctrl-D` | Exit NightHawk CLI when the input box is empty |
...
- [`nighthawk` Command](./nighthawk-command.md) — Complete reference for startup flags and subcommands
