...
- `src/_base/errors/serialize.ts`: `ErrorPayload`, `isCodedError`, `toErrorPayload`, `fromErrorPayload`. Wire-facing names (`NighthawkErrorPayload`, `toNighthawkErrorPayload`) mirror the protocol and are kept as-is.
