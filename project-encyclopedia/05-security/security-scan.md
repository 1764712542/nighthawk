...
### 来自 `packages/agent-core/src/tools/builtin/security/security-scan.ts` 的 `SecurityScanTool`

源码位置：`packages/agent-core/src/tools/builtin/security/security-scan.ts:53` 附近。
...
> 图注：`05-security/security-scan.md` 的抽象流程；具体参与者与状态以源码和上文函数说明为准。
