...
### 来自 `packages/agent-core/src/tools/builtin/security/secret-scan.ts` 的 `SecretScanTool`

源码位置：`packages/agent-core/src/tools/builtin/security/secret-scan.ts:36` 附近。
...
> 图注：`05-security/secret-scan.md` 的抽象流程；具体参与者与状态以源码和上文函数说明为准。
