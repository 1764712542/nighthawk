...
本文档是 NightHawk 项目百科全书的入口，说明如何阅读 183 篇 Markdown、文档分类和证据约定。
...
文档分为：项目概览、全仓库遍历、完整源码地图、架构、应用层、核心包、功能特性、安全引擎、数据流、技术栈、开发、竞品对比、术语表、参考手册、Vibe Coding 指南、未实现功能清单。每一篇都独立可读，同时通过链接互相引用。
...
本目录包含 183 篇 Markdown 文档，覆盖 22 个应用/包、核心 Agent 循环、安全工具、服务端、SDK、TUI、VS Code 扩展、数据层、工程化设施、Vibe Coding 提示词、官方插件、仓库技能、包导出索引、关键架构决策与未实现功能报告。
