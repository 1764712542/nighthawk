 ...
 *  - Legacy Python legacy-cli (< v0.9.0) ids `approve` / `approve_for_session`
...
export function permissionResponseToApprovalResponse(
  ...
  switch (optionId) {
    ...
    // Legacy Python legacy-cli (< v0.9.0) used 'approve' as the allow-once
    ...
    // Legacy Python legacy-cli (< v0.9.0) used 'approve_for_session' as the
