...
import type { SessionApprovalRequest } from '@nighthawk/agent-core-v2';
import type { ToolInputDisplay } from '@nighthawk/protocol';
...
describe('permissionResponseToApprovalResponse', () => {
  ...
  it('maps the legacy Python legacy-cli optionIds like their canonical counterparts', () => {
