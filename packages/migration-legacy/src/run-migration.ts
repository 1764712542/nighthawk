...
const CONFIG_CONFLICT_NOTICE =
  'Your existing config.toml could not be parsed; migrated copy saved to ~/.nighthawk/config.migrated-from-legacy-cli.toml — please review and merge manually.';

const TUI_CONFLICT_NOTICE =
  'Your existing tui.toml had user modifications; migrated copy saved to ~/.nighthawk/tui.migrated-from-legacy-cli.toml — please review and merge manually.';
