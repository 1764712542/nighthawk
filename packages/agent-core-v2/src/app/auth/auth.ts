...
export interface IOAuthToolkit {
  ...
  login(providerName?: string, options?: NighthawkOAuthLoginOptions): Promise<NighthawkOAuthLoginResult>;
  logout(providerName?: string, oauthRef?: NighthawkOAuthTokenRef): Promise<NighthawkOAuthLogoutResult>;
  getCachedAccessToken(
    providerName?: string,
    oauthRef?: NighthawkOAuthTokenRef,
  ): Promise<string | undefined>;
  tokenProvider(providerName?: string, oauthRef?: NighthawkOAuthTokenRef): BearerTokenProvider;
  getManagedUsage(
    providerName?: string,
    options?: { readonly oauthRef?: NighthawkOAuthTokenRef; readonly baseUrl?: string },
