...
import type { NighthawkErrorPayload } from '#/_base/errors/serialize';
...
export class AgentErrorEvent extends AgentEvent2<NighthawkErrorPayload & AgentDomainTrait> {
  static override readonly type = 'error';
  static override readonly observable = true;
}
export interface AgentErrorEvent extends NighthawkErrorPayload {
  readonly agentId: string;
}
