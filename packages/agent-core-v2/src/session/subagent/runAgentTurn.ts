...
import { Error2, ErrorCodes, toNighthawkErrorPayload, type NighthawkErrorPayload } from '#/errors';
...
function providerRateLimitErrorFromPayload(error: NighthawkErrorPayload): APIProviderRateLimitError {
  const requestId =
