...
import { ErrorCodes, Error2, errorInfo, toNighthawkErrorPayload } from '#/errors';
...
function endTurn(
  ...
  const error = result.error !== undefined ? toNighthawkErrorPayload(result.error) : undefined;
  eventBus.publish(
