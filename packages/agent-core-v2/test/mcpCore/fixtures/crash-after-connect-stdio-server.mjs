...
const exitCode = Number.parseInt(process.env['NIGHTHAWK_TEST_MCP_EXIT_CODE'] ?? '1', 10);
const stderrBanner = process.env['NIGHTHAWK_TEST_MCP_STDERR'];
...
const exitAfterMsRaw = process.env['NIGHTHAWK_TEST_MCP_EXIT_AFTER_MS'];
