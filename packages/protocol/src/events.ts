...
export type NighthawkErrorCode =
  | 'config.invalid'
...
export interface NighthawkErrorPayload {
  ...
  readonly cause?: NighthawkErrorPayload;
}
...
export interface ErrorEvent extends NighthawkErrorPayload {
  readonly type: 'error';
}
...
export interface TurnEndedEvent {
  ...
  readonly turnId: number;
  readonly reason: TurnEndReason;
  readonly error?: NighthawkErrorPayload;
  readonly durationMs?: number;
...
export const nighthawkErrorCodeSchema = z.enum([
  ...
  'not_implemented',
  'internal',
]) satisfies z.ZodType<NighthawkErrorCode>;

export const nighthawkErrorPayloadSchema: z.ZodType<NighthawkErrorPayload> = z.lazy(
...
}) satisfies z.ZodType<NighthawkErrorPayload>;
