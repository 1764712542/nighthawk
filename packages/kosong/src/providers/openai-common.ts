...
// equivalent vendor-specific signals (e.g. NightHawk's
...
export function extractUsage(usage: unknown): TokenUsage | null {
  ...
  let cached = 0;
  // NightHawk proprietary: top-level cached_tokens
 ...
 *
 * Used by both the NightHawk and OpenAI Legacy adapters because they share the
