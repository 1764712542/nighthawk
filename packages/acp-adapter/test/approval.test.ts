...
describe('permissionResponseToApprovalResponse', () => {
  ...
  it('maps legacy "approve" → { decision: approved } (Python legacy-cli compat)', () => {
    const result = permissionResponseToApprovalResponse(undefined, {
  ...
  it('maps legacy "approve_for_session" → { decision: approved, scope: session } (Python legacy-cli compat)', () => {
    const result = permissionResponseToApprovalResponse(undefined, {
