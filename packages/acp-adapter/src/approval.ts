...
import type { ApprovalRequest, ApprovalResponse } from '@nighthawk/nighthawk-sdk';
 ...
 *    options surfaced in the TUI by `apps/nighthawk/src/tui/reverse-rpc/approval/adapter.ts:13`'s
...
/**
 * Translate an ACP {@link RequestPermissionResponse} into NightHawk's
...
export function permissionResponseToApprovalResponse(
  ...
  switch (optionId) {
    ...
    // Legacy Python legacy-cli (< v0.9.0) used 'approve' as the
    ...
    // Legacy Python legacy-cli (< v0.9.0) used 'approve_for_session' as
