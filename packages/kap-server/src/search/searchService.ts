...
import { normalizeLiteral, tokenize } from '@nighthawk/minidb';
import type { TranscriptStore } from '@nighthawk/transcript';
 ...
 * thread (default ON). Disable via `NIGHTHAWK_EXPERIMENTAL_SEARCH_WORKER=false`
...
registerFlagDefinition({
  ...
  env: 'NIGHTHAWK_EXPERIMENTAL_SEARCH_WORKER',
  default: true,
  surface: 'core',
});
