...
} from '@nighthawk/agent-core-v2/app/sessionLegacy/sessionProtocol';

export { promptPermissionModeSchema, promptThinkingSchema };
export type { PromptPermissionMode, PromptThinking } from '@nighthawk/agent-core-v2/app/sessionLegacy/sessionProtocol';
