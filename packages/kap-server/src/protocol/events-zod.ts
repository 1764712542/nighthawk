...
import { isoDateTimeSchema } from '@nighthawk/agent-core-v2/_base/utils/isoDateTime';
...
import type {
  ...
  TaskOrigin,
  UserPromptOrigin,
} from '@nighthawk/agent-core-v2/agent/contextMemory/types';
import { messageContentSchema } from './message';
import type { HookResultPayload } from '@nighthawk/agent-core-v2/features/externalHooks/agent/agentExternalHooksService';
import type {
  CompactionBlockedPayload,
  CompactionCompletedPayload,
  CompactionStartedPayload,
} from '@nighthawk/agent-core-v2/agent/fullCompaction/compactionOps';
import type { CompactionResult } from '@nighthawk/agent-core-v2/agent/fullCompaction/types';
import type {
  GoalActor,
  GoalBudgetLimits,
  GoalBudgetReport,
...
} from '@nighthawk/agent-core-v2/agent/loop/turnEvents';
import type {
  McpServerStatusEventPayload,
  McpServerStatusPayload,
  ToolListUpdatedPayload,
  ToolListUpdatedReason,
} from '@nighthawk/agent-core-v2/agent/mcp/mcpEvents';
import type { McpOAuthAuthorizationUrlUpdateData } from '@nighthawk/agent-core-v2/agent/mcp/tools/auth';
import type { PermissionMode } from '@nighthawk/agent-core-v2/agent/permissionPolicy/types';
import type { WarningEvent } from '@nighthawk/agent-core-v2/agent/profile/profileService';
import type { PluginCommandActivatedPayload } from '@nighthawk/agent-core-v2/agent/pluginCommand/pluginCommand';
import type {
  ShellCompletedPayload,
  ShellOutputPayload,
  ShellStartedPayload,
} from '@nighthawk/agent-core-v2/agent/shellCommand/shellCommandService';

import type { TurnStepRetryingPayload } from '@nighthawk/agent-core-v2/agent/stepRetry/stepRetryService';
import type { AgentTaskStatus } from '@nighthawk/agent-core-v2/agent/task/types';
import type {
  ToolCallStartedPayload,
  ToolProgressPayload,
  ToolResultEventPayload,
} from '@nighthawk/agent-core-v2/agent/toolExecutor/toolExecutorEvents';
import type { UsageStatus } from '@nighthawk/agent-core-v2/agent/usage/usage';
import type { FinishReason } from '@nighthawk/agent-core-v2/kosong/contract/provider';
import type { TokenUsage } from '@nighthawk/agent-core-v2/kosong/contract/usage';
import type {
  SubagentCompletedPayload,
  SubagentFailedPayload,
  SubagentSpawnedPayload,
  SubagentStartedPayload,
} from '@nighthawk/agent-core-v2/session/subagent/mirrorAgentRun';
import type { SubagentSuspendedPayload } from '@nighthawk/agent-core-v2/features/swarm/session/sessionSwarmService';
import type { ToolUpdate } from '@nighthawk/agent-core-v2/tool/toolContract';
...
export const nighthawkErrorCodeSchema = z.enum([
  'config.invalid',
  'session.not_found',
...
export const nighthawkErrorPayloadSchema: z.ZodType<unknown> = z.lazy(
  () => nighthawkErrorPayloadObjectSchema,
);

const nighthawkErrorPayloadObjectSchema = z.object({
  code: nighthawkErrorCodeSchema,
  message: z.string(),
  name: z.string().optional(),
  details: z.record(z.string(), z.unknown()).optional(),
  retryable: z.boolean(),
  cause: nighthawkErrorPayloadSchema.optional(),
});
...
export const errorEventSchema = nighthawkErrorPayloadObjectSchema.extend({
...
export const turnEndedEventSchema = z.object({
  ...
  turnId: z.number(),
  reason: turnEndReasonSchema,
  error: nighthawkErrorPayloadSchema.optional(),
  durationMs: z.number().optional(),
  interruptReason: z
