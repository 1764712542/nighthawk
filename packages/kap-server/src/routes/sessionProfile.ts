...
import type { SessionWireFields } from '@nighthawk/agent-core-v2/app/sessionLegacy/sessionLegacy';
import type { UpdateSessionProfileRequest } from '@nighthawk/agent-core-v2/app/sessionLegacy/sessionProtocol';
