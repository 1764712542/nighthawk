...
} from '@nighthawk/agent-core-v2/agent/media/sessionMediaStore';
import {
  FileErrors,
  IFileService,
  isFileError,
} from '@nighthawk/agent-core-v2/app/file/fileService';
import { resumeSessionById } from '@nighthawk/agent-core-v2/app/sessionManager/sessionLookup';
import type { Scope } from '@nighthawk/agent-core-v2/_base/di/scope';
import { z } from 'zod';
