import { IConfigService, type Scope } from '@nighthawk/agent-core-v2';
import { FiberState } from '@nighthawk/agent-core-v2/_base/di/fiber';
...
export interface RegisterApiV1RoutesOptions {
   ...
   */
  readonly hostIdentity: NighthawkHostIdentity;
