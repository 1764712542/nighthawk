...
import { RuntimeError } from '@nighthawk/agent-core-v2/runtime/runtimeRegistry';
import {
  fsDiffRequestSchema,
...
} from '@nighthawk/agent-core-v2/workspace/workspaceFs/fs';
import { GitService } from '@nighthawk/agent-core-v2/app/git/gitService';
import type { IHostFileSystem } from '@nighthawk/agent-core-v2/os/interface/hostFileSystem';
import type { RuntimeCapability, RuntimeLease } from '@nighthawk/agent-core-v2/runtime/runtime';
import { WorkspaceFsService } from '@nighthawk/agent-core-v2/workspace/workspaceFs/fsService';
import { WorkspaceGitService } from '@nighthawk/agent-core-v2/workspace/workspaceGit/workspaceGitService';
import type { IWorkspaceContext } from '@nighthawk/agent-core-v2/workspace/workspaceContext/workspaceContext';
import type { IWorkspaceDirs } from '@nighthawk/agent-core-v2/workspace/workspaceDirs/workspaceDirs';
import { z } from 'zod';
