...
import { createNighthawkDeviceId } from '@nighthawk/nighthawk-oauth';

const SERVER_TELEMETRY_APP_NAME = 'nighthawk-cli';
const SERVER_TELEMETRY_UI_MODE = 'web';
const TELEMETRY_DISABLE_ENV = 'NIGHTHAWK_DISABLE_TELEMETRY';
...
export async function initializeServerTelemetry(
  ...
  const appender = createCloudAppender(core.accessor, {
    deviceId: createNighthawkDeviceId(homeDir),
