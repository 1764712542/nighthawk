import { daemonFileRefFromPart, parseDaemonFileUrl, type ContentPart, type ContextMessage } from '@nighthawk/agent-core-v2';
 ...
 * the internal `nighthawk-file://` URL becomes the stored read-model contract.
 */
