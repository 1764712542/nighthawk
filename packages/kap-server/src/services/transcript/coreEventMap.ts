import type { AgentActivityUpdated } from '@nighthawk/agent-core-v2/agent/activityView/activityView';
import type { ContextSpliced } from '@nighthawk/agent-core-v2/agent/contextMemory/contextEvents';
import type { HookResult } from '@nighthawk/agent-core-v2/features/externalHooks/agent/agentExternalHooksService';
import type {
  CompactionBlocked,
  CompactionCancelled,
  CompactionCompleted,
...
import type { ContentPart, CronFired, GoalUpdated } from '@nighthawk/agent-core-v2';
import type {
  AssistantDelta,
  ThinkingDelta,
  ToolCallDelta,
...
import type { TurnEnded } from '@nighthawk/agent-core-v2/agent/loop/turnOps';
import type { AgentErrorEvent } from '@nighthawk/agent-core-v2/agent/mcp/mcpEvents';
import type { PluginCommandActivated } from '@nighthawk/agent-core-v2/agent/pluginCommand/pluginCommand';
import type { WarningIssued } from '@nighthawk/agent-core-v2/agent/profile/profileOps';
import type {
  PromptAborted,
  PromptCompleted,
  PromptSteered,
} from '@nighthawk/agent-core-v2/agent/prompt/promptService';
import type { PromptAccepted } from '@nighthawk/agent-core-v2/agent/prompt/promptOps';
import type { PromptQueued } from '@nighthawk/agent-core-v2/agent/prompt/promptService';
import type {
  ShellCompleted,
  ShellOutput,
  ShellStarted,
} from '@nighthawk/agent-core-v2/agent/shellCommand/shellCommandService';
import type { SkillActivated } from '@nighthawk/agent-core-v2/features/skill/skillOps';
import type { TurnStepRetrying } from '@nighthawk/agent-core-v2/agent/stepRetry/stepRetryService';
import type {
  TaskNotified,
  TaskStarted,
  TaskTerminatedNotice,
} from '@nighthawk/agent-core-v2/agent/task/taskOps';
import type {
  ToolCallStarted,
  ToolProgress,
  ToolResultEvent,
} from '@nighthawk/agent-core-v2/agent/toolExecutor/toolExecutorEvents';
import type { AgentStatusUpdated } from '@nighthawk/agent-core-v2/agent/usage/usageEvents';
import type { PlanRevision } from '@nighthawk/agent-core-v2/features/plan/planOps';
import type { SubagentSuspended } from '@nighthawk/agent-core-v2/features/swarm/session/sessionSwarmService';
import type {
  SubagentCompleted,
  SubagentFailed,
  SubagentSpawned,
