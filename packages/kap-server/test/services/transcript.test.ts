...
import { Emitter, Event } from '@nighthawk/agent-core-v2/_base/event';
import { TowerStore } from '@nighthawk/agent-core-v2/features/tower/protocol/index';
import {
  AgentTranscript,
  TranscriptStore,
