...
import { authSummarySchema, type AuthSummary } from '@nighthawk/agent-core-v2/app/authLegacy/authLegacy';
...
describe('server-v2 GET /api/v1/auth', () => {
  ...
  beforeEach(async () => {
    home = await mkdtemp(join(tmpdir(), 'nighthawk-server-v2-auth-'));
  });
