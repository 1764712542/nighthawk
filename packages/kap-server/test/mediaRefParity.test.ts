...
const URLS = [
  'nighthawk-file://f_1?path=%2Fcache%2Fshot.png',
  'nighthawk-file://f_1',
  'nighthawk-file://f_1?path=',
  'nighthawk-file://?path=%2Fcache%2Fshot.png',
  'nighthawk-file://f_1?path=%2Fcache%2Fa%20%26%20%22b%22%20%3Cc%3E.png',
  'nighthawk-file://f_1?path=%zz',
  'nighthawk-file://',
...
const PARTS: ReadonlyArray<MediaRefPart> = [
  { type: 'image_url', imageUrl: { url: 'nighthawk-file://f_1?path=%2Fcache%2Fshot.png' } },
  { type: 'video_url', videoUrl: { url: 'nighthawk-file://f_3?path=%2Fcache%2Fclip.mp4' } },
  { type: 'image_url', imageUrl: { url: 'nighthawk-file://f_1' } },
