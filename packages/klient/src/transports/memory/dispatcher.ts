...
import type { IAgentScopeHandle } from '@nighthawk/agent-core-v2/_base/di/scope';
...
import { ensureMainAgent } from '@nighthawk/agent-core-v2/session/agentLifecycle/mainAgent';
import { agentContextOf } from '@nighthawk/agent-core-v2/agent/scopeContext/scopeContext';
import { AgentInteraction } from '@nighthawk/agent-core-v2/features/interaction/interactionAgentRuntime';
import type {
  InteractionKind,
  InteractionRequest,
} from '@nighthawk/agent-core-v2/features/interaction/interaction';
import type { SkillActivationOrigin } from '@nighthawk/agent-core-v2/agent/contextMemory/types';
import type {
  PromptWithSkillsInput,
  SkillActivationInput,
} from '@nighthawk/agent-core-v2/features/skill/skill';
import { AgentSkill } from '@nighthawk/agent-core-v2/features/skill/skillAgentRuntime';
import {
...
} from '@nighthawk/agent-core-v2/features/interaction/sessionInteractions';
import { IEventBus } from '@nighthawk/agent-core-v2/app/event/eventBus';
import type {
  FileMeta,
  GetResult,
  SaveOptions,
} from '@nighthawk/agent-core-v2/app/file/fileService';
import { FileErrors } from '@nighthawk/agent-core-v2/app/file/fileService';
import { Error2, ErrorCodes } from '@nighthawk/agent-core-v2/errors';
