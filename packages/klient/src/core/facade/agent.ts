...
import type { IAgentContextMemoryService } from '@nighthawk/agent-core-v2/agent/contextMemory/contextMemory';
import type { IAgentMcpService } from '@nighthawk/agent-core-v2/agent/mcp/mcp';
...
import type { ISessionTokenCountingService } from '@nighthawk/agent-core-v2/session/tokenCounting/sessionTokenCounting';
import type { IAgentPlanService } from '@nighthawk/agent-core-v2/features/plan/plan';
...
import type { IAgentTaskService } from '@nighthawk/agent-core-v2/agent/task/task';
import type { ISessionUsageService } from '@nighthawk/agent-core-v2/session/usage/sessionUsage';
