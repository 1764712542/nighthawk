...
import type { Message, StreamedMessagePart } from '@nighthawk/agent-core-v2/kosong/contract/message';
...
import type { ResponseFormat } from '@nighthawk/agent-core-v2/kosong/contract/provider';
