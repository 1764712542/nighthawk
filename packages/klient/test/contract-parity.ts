 ...
 *
 * Wire shapes the engine imports from `@nighthawk/protocol` are reached
...
import type {
  ...
  ToolCallRef,
  TurnPhase,
} from '@nighthawk/agent-core-v2/agent/activityView/activityView';
import type { AgentContextData } from '@nighthawk/agent-core-v2/agent/contextMemory/types';
import type { IAgentCommandService } from '@nighthawk/agent-core-v2/agent/command/agentCommand';
import type { IAgentRuntimeBindingService } from '@nighthawk/agent-core-v2/agent/runtimeBinding/runtimeBinding';
import type { TurnEndReason } from '@nighthawk/agent-core-v2/agent/loop/turnEvents';
import type { PermissionMode } from '@nighthawk/agent-core-v2/agent/permissionPolicy/types';
import type { IAgentProfileService } from '@nighthawk/agent-core-v2/agent/profile/profile';
import type { IAgentPromptService } from '@nighthawk/agent-core-v2/agent/prompt/prompt';
import type { IAgentShellCommandService } from '@nighthawk/agent-core-v2/agent/shellCommand/shellCommand';
import type { SkillRuntime } from '@nighthawk/agent-core-v2/features/skill/skillAgentRuntime';
import type { ContentPart } from '@nighthawk/agent-core-v2/kosong/contract/message';
import type { PlanData } from '@nighthawk/agent-core-v2/features/plan/plan';
import type { UsageStatus } from '@nighthawk/agent-core-v2/agent/usage/usage';
import type { SkillSummary } from '@nighthawk/agent-core-v2/features/skill/catalog/types';
import type { McpServerEntry } from '@nighthawk/agent-core-v2/mcpCore/connection-manager';
import type {
  ...
  McpServerTestResult,
  McpServerTestTarget,
} from '@nighthawk/agent-core-v2/app/mcpManagement/mcpManagement';
import type {
  McpRegistryPluginOrigin,
  McpRegistryQuery,
  McpServerSource,
} from '@nighthawk/agent-core-v2/app/mcpRegistry/mcpRegistry';
import type { McpServerConfig } from '@nighthawk/agent-core-v2/mcpCore/config-schema';
import type { McpServerConfigView } from '@nighthawk/agent-core-v2/mcpCore/configView';
import type { FullCompactionInput } from '@nighthawk/agent-core-v2/agent/fullCompaction/fullCompaction';
import type { ISessionScopeHandle } from '@nighthawk/agent-core-v2/_base/di/scope';
import type {
  CreateChildSessionOptions,
  CreateSessionOptions,
  ForkSessionOptions,
  ResumeSessionOptions,
} from '@nighthawk/agent-core-v2/workspace/sessionLifecycle/sessionLifecycle';
import type {
  ApprovalRequest,
  ApprovalResponse,
} from '@nighthawk/agent-core-v2/session/approval/approval';
import type {
  Interaction,
  InteractionResolution,
} from '@nighthawk/agent-core-v2/features/interaction/interaction';
import type {
  QuestionAnswers,
  QuestionItem,
  QuestionOption,
  ...
  QuestionResponse,
  QuestionResult,
} from '@nighthawk/agent-core-v2/session/question/question';
import type {
  AgentMeta,
  SessionMeta,
  SessionMetadataChangedEvent,
  SessionMetaPatch,
} from '@nighthawk/agent-core-v2/session/sessionMetadata/sessionMetadata';
import type { ISessionTitleService } from '@nighthawk/agent-core-v2/session/sessionTitle/sessionTitle';
import type {
  AuthStatus,
  IOAuthService,
} from '@nighthawk/agent-core-v2/app/auth/auth';
import type { IBootstrapService } from '@nighthawk/agent-core-v2/app/bootstrap/bootstrap';
import type {
  ConfigDiagnostic,
  ConfigInspectValue,
  ConfigTarget,
} from '@nighthawk/agent-core-v2/app/config/config';
import type {
  CapabilityInstallProgress,
  CapabilityStatus,
  CapabilityStep,
} from '@nighthawk/agent-core-v2/app/capability/types';
import type { ExperimentalFeatureState } from '@nighthawk/agent-core-v2/app/flag/flag';
import type {
  FileMeta,
  SaveOptions,
} from '@nighthawk/agent-core-v2/app/file/fileService';
import type {
  FsBrowseResponse,
  FsHomeResponse,
} from '@nighthawk/agent-core-v2/app/hostFolderBrowser/hostFolderBrowser';
import type { ModelRecord } from '@nighthawk/agent-core-v2/kosong/model/model';
import type { IModelCatalog } from '@nighthawk/agent-core-v2/kosong/model/catalog';
import type { IProviderDiscoveryService } from '@nighthawk/agent-core-v2/app/kosongConfig/discovery';
import type {
  GetPluginInfoInput,
  InstallPluginInput,
  RemovePluginInput,
...
} from '@nighthawk/agent-core-v2/app/plugin/plugin';
import type {
  PluginCommandDef,
  PluginDiagnostic,
  ...
  PluginUpdateStatus,
  ReloadSummary,
} from '@nighthawk/agent-core-v2/app/plugin/types';
import type { ProviderConfig } from '@nighthawk/agent-core-v2/kosong/provider/provider';
import type {
  SessionListQuery,
  SessionSummary,
} from '@nighthawk/agent-core-v2/app/sessionIndex/sessionIndex';
import type {
  Workspace,
  WorkspaceUpdate,
} from '@nighthawk/agent-core-v2/app/workspace/workspace';
// Test-only: `@nighthawk/protocol` is a devDependency; importing its types
...
// `@nighthawk/protocol` dependency in klient).
