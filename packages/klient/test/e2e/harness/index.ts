/**
 * `@nighthawk/server-e2e` — wire-level test client for the nighthawk server.
 *
 ...
 *
 * Re-exports `@nighthawk/protocol` types are NOT bundled here — scenarios
 * that want them import from `@nighthawk/protocol` directly.
 */
