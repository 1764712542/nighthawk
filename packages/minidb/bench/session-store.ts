...
//
// Schema + query layer for the nighthawk session store, built on minidb.
//
...
export class SessionStore {
  ...
  async ingestNighthawk(homeDir: string): Promise<{ workspaces: number; sessions: number; textBytes: number }> {
