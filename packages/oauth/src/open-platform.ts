...
export function capabilitiesForModel(model: ManagedNighthawkModelInfo): string[] | undefined {
...
export function filterModelsByPrefix(
  models: ManagedNighthawkModelInfo[],
  platform: OpenPlatformDefinition,
): ManagedNighthawkModelInfo[] {
...
export function applyOpenPlatformConfig(
  ...
  options: {
    ...
    readonly selectedModel: ManagedNighthawkModelInfo;
