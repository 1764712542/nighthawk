...
describe('AgentBackgroundTask — timeoutMs', () => {
  ...
  // nighthawk do NOT carry an implicit default timeout. The Python
  // legacy-cli enforced a 30-min default because its agents were
  // expected to be short-lived; nighthawk's agents may legitimately
  ...
  // Contract decision (2026-05-21): nighthawk treats `timeoutMs: 0`
