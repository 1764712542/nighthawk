...
import type { ContentPart, ModelCapability, TokenUsage } from '@nighthawk/kosong';
...
function _typeOnlyChecks(): void {
  ...
  void _badStop1;
  // @ts-expect-error - max_steps is represented by a thrown NighthawkError, not StopReason.
