...
import { APIRequestTooLargeError, APIStatusError, type Message } from '@nighthawk/kosong';
...
// The OpenAI-compatible (NightHawk / NightHawk) phrasing of the same tool-exchange
...
describe('executeLoopStep — tool exchange adjacency fallback', () => {
  ...
  it('resends once and recovers after a NightHawk tool_call_id-not-found 400', async () => {
