...
export const MASTER_ENV = 'NIGHTHAWK_EXPERIMENTAL_FLAG';
 ...
 *   L1 master switch NIGHTHAWK_EXPERIMENTAL_FLAG → every flag is on
 ...
 * Runtime code that belongs to a NighthawkCore/Session/Agent should use the scoped
