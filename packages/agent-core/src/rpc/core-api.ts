...
import type { NighthawkConfig, NighthawkConfigPatch, McpServerConfig } from '#/config';
...
export type { NighthawkConfig, NighthawkConfigPatch };
...
export interface ExportSessionPayload {
  ...
  /**
   * When true, the active global diagnostic log (`$NIGHTHAWK_HOME/logs/nighthawk.log`)
   * is copied into the zip at `logs/global/nighthawk.log`. Off by default to
...
export interface ExportSessionManifest {
  ...
  readonly nighthawkVersion: string;
...
export interface GetNighthawkConfigPayload {
...
export type SetNighthawkConfigPayload = NighthawkConfigPatch;

export interface RemoveNighthawkProviderPayload {
...
export interface CoreAPI extends SessionAPIWithId {
  ...
  getNighthawkConfig: (payload: GetNighthawkConfigPayload) => NighthawkConfig;
  getConfigDiagnostics: (payload: EmptyPayload) => ConfigDiagnostics;
  setNighthawkConfig: (payload: SetNighthawkConfigPayload) => NighthawkConfig;
  removeNighthawkProvider: (payload: RemoveNighthawkProviderPayload) => NighthawkConfig;
