...
import type { ChatProvider, Tool } from '@nighthawk/kosong';
      ...
      [
        ...
        new b.BashTool(kaos, cwd, background, {
          ...
          autoBackgroundOnTimeout:
            this.agent.nighthawkConfig?.background?.bashAutoBackgroundOnTimeout ?? true,
          backgroundTimeoutS: this.agent.nighthawkConfig?.background?.bashTaskTimeoutS,
        }),
        ...
        new b.SecurityScanTool(kaos, workspace),
        new b.SecretScanTool(kaos, workspace),
        new b.TaintTraceTool(kaos, workspace),
        new b.DepAuditTool(kaos, workspace),
        ...
        this.agent.subagentHost &&
          new b.AgentTool(
            ...
            this.agent.subagentHost.delegatableSubagents(this.agent.config.profileName),
            {
              allowBackground,
              log: this.agent.log,
              subagentTimeoutMs: resolveSubagentTimeoutMs(this.agent.nighthawkConfig?.subagent?.timeoutMs),
        ...
        this.agent.subagentHost &&
          new b.AgentSwarmTool(
            ...
            resolveSubagentTimeoutMs(this.agent.nighthawkConfig?.subagent?.timeoutMs),
