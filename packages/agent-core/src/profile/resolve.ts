 ...
 * (NIGHTHAWK_OS, NIGHTHAWK_AGENTS_MD, ...) at render time.
 */
...
function buildTemplateVars(
  ...
  return {
    ...promptVars,
    NIGHTHAWK_OS: context.osEnv.osKind,
    NIGHTHAWK_SHELL: `${context.osEnv.shellName} (\`${context.osEnv.shellPath}\`)`,
    NIGHTHAWK_NOW: now,
    NIGHTHAWK_WORK_DIR: context.cwd,
    NIGHTHAWK_WORK_DIR_LS: context.cwdListing ?? '',
    NIGHTHAWK_AGENTS_MD: context.agentsMd ?? '',
    NIGHTHAWK_SKILLS: tools.includes('Skill') ? skills : '',
    NIGHTHAWK_PLUGIN_SECTIONS: context.pluginSections ?? '',
    NIGHTHAWK_ADDITIONAL_DIRS_INFO: context.additionalDirsInfo ?? '',
    ...
    NIGHTHAWK_WINDOWS_NOTES: WINDOWS_NOTES,
    NIGHTHAWK_ADDITIONAL_DIRS_SECTION_PROSE: ADDITIONAL_DIRS_SECTION_PROSE,
    NIGHTHAWK_SKILLS_SECTION_PROSE: SKILLS_SECTION_PROSE,
    ROLE_ADDITIONAL:
