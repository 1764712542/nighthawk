import type { NighthawkConfig } from './schema';

/**
 * Print-mode (`nighthawk -p`) defaults for the v1 engine. A headless run should not
 ...
 */
export function applyPrintModeConfigDefaults(config: NighthawkConfig): NighthawkConfig {
  return {
    ...config,
