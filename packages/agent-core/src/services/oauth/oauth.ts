 ...
 * the `managed:nighthawk` provider + models entry are written to
 ...
 *
 *           ┌─ resolves with NighthawkAuthLoginResult  →  flow status = 'authenticated'
...
export interface IOAuthService {
   ...
   * `'managed:nighthawk'`). Requests the device authorization synchronously
