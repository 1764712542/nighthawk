 ...
 *
 * **Anti-corruption**: imports `@nighthawk/agent-core` only for the
 * `createDecorator` value.
 */

import { createDecorator } from '../../di';
import type { ToolDescriptor, ToolSource } from '@nighthawk/protocol';
 ...
 * `@nighthawk/agent-core` `ToolInfo` without taking a runtime dependency on
