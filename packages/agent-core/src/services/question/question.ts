 ...
 * role — routes `QuestionRequest`s coming out of `NighthawkCore` to a waiter
 ...
 *      `BridgeClientAPI` sees from `NighthawkCore.requestQuestion(...)`. See
...
export interface IQuestionService {
  ...
  /**
   * Called by the adapter when NighthawkCore needs the user to answer a question.
