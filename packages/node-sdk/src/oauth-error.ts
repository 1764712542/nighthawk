...
/**
 * Classify an OAuth token-fetch failure into the public {@link NighthawkError}
 ...
 * remediation path.
 */
export function mapOAuthTokenError(error: unknown, providerName: string): NighthawkError | undefined {
