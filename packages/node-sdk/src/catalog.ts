import type { NighthawkConfig, ModelAlias } from '@nighthawk/agent-core';
import {
  catalogBaseUrl,
...
/** Builds a nighthawk model alias from a normalized catalog model. */
 ...
 * `__NIGHTHAWK_BUILT_IN_CATALOG__` constant injected by tsdown at build
