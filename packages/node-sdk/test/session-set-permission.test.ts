...
import { createNighthawkHarness, type NighthawkError, type PermissionMode } from '#/index';
...
describe('Session.setPermission', () => {
  it.each(['yolo', 'manual', 'auto'] as const)(
    ...
    async (mode: PermissionMode) => {
      const homeDir = await makeTempDir(tempDirs, 'nighthawk-sdk-permission-home-');
      const workDir = await makeTempDir(tempDirs, 'nighthawk-sdk-permission-work-');
