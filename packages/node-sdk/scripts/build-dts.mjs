...
const workspacePackages = new Map([
  ['@nighthawk/agent-core-v2', 'agent-core-v2'],
  ['@nighthawk/agent-core', 'agent-core'],
  ['@nighthawk/kaos', 'kaos'],
  ['@nighthawk/nighthawk-oauth', 'oauth'],
  ['@nighthawk/klient', 'klient'],
  ['@nighthawk/kosong', 'kosong'],
]);
  ...
  await Promise.all(
    files.map(async (file) => {
      ...
      const updated = providerClientText.replaceAll(
        /(["'])(#\/[^"']+|@nighthawk\/(?:agent-core-v2|agent-core|kaos|nighthawk-oauth|klient|kosong)(?:\/[^"']+)?)\1/g,
