...
Currently, NightHawk only provides security support for the latest released version.
...
- GitHub Security Advisories — https://github.com/nighthawk-dev/nighthawk/security/advisories/new
  (private disclosure, tracked with the codebase)

## What to Include

- Affected version (output of `nighthawk --version`)
- Reproduction steps
- Impact assessment
