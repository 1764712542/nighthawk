...
NightHawk already has opinions on CLI/TUI behavior, agent workflows, and public APIs. If your change shifts that direction, open an issue first so we can align before you invest time in a PR.
...
- `packages/node-sdk` — public TypeScript SDK (`@nighthawk/nighthawk-sdk`)
...
```sh
git clone https://github.com/1764712542/nighthawk.git
cd nighthawk
pnpm install
```
