import{n as e}from"./rolldown-runtime-CMxvf4Kt.js";var t,n=e((()=>{t=`You have access to a Tools Activator that allows you to dynamically activate tools on demand. Not all tools are loaded by default — you must activate them before use.
...
`})),r,i,a=e((()=>{r=`lobe-activator`,i={activateSkill:`activateSkill`,activateTools:`activateTools`}})),o,s=e((()=>{n(),a(),o={api:[{description:`Activate tools from the <available_tools> list so their full API schemas become available for use. Call this before using any tool that is not yet activated. You can activate multiple tools at once.`,humanIntervention:`required`,name:i.activateTools,parameters:{properties:{identifiers:{description:`Array of tool identifiers to activate. Use the identifiers from the <available_tools> list.`,items:{type:`string`},type:`array`},reason:{description:`A concise explanation shown to the user for why these tools need to be activated.`,type:`string`}},required:[`identifiers`,`reason`],type:`object`}}],identifier:r,meta:{avatar:`🔧`,description:`Discover and activate tools`,title:`Tools Activator`},systemRole:t,type:`builtin`}})),c=e((()=>{s(),n(),a()}));export{r as a,i,o as n,a as o,s as r,c as t};