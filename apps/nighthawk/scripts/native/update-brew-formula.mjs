 ...
 * install NightHawk with `brew install 1764712542/nighthawk/nighthawk`.
...
const formula = `class Nighthawk < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/1764712542/nighthawk/releases/download/#{version}/nighthawk-darwin-arm64.zip"
      sha256 "${sha.darwinArm64}"
    else
      url "https://github.com/1764712542/nighthawk/releases/download/#{version}/nighthawk-darwin-x64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/1764712542/nighthawk/releases/download/#{version}/nighthawk-linux-arm64.zip"
      sha256 "${sha.linuxArm64}"
    else
      url "https://github.com/1764712542/nighthawk/releases/download/#{version}/nighthawk-linux-x64.zip"
      sha256 "${sha.linuxX64}"
    end
  end
