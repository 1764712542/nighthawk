...
import type { PromptPart } from '@nighthawk/nighthawk-sdk';
...
describe('combineSteerInput', () => {
  const refPart = {
    type: 'image_url',
    imageUrl: { url: 'nighthawk-file://f_1?path=%2Fcache%2Ff_1.png' },
  } as const;
  ...
  it.each([
    ...
    const refPart2 = {
      type: 'image_url',
      imageUrl: { url: 'nighthawk-file://f_2?path=%2Fcache%2Ff_2.png' },
    } as const;
