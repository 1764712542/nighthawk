...
function makeDriver(): { driver: SignalDriver; tui: NighthawkTUI } {
  const tui = new NighthawkTUI(makeHarness() as never, makeStartupInput());
...
describe('NighthawkTUI signal handlers', () => {
