 ...
 *
 * Run:
 *   pnpm --filter @nighthawk/nighthawk exec vitest bench test/tui/tui-frame.bench.ts
 */

import type { Component, Terminal } from '@nighthawk/pi-tui';
import { TuiMainScreen } from '@nighthawk/pi-tui';
