 ...
 * NightHawk OAuth (`DEFAULT_OAUTH_PROVIDER_NAME`) is intentionally hidden
 ...
 * through callbacks. The host (`NighthawkTui`) is responsible for performing
...
// Mirrors `readCustomRegistrySource` in `nighthawk-tui.ts`. We can't import
