...
const WEB_BRIDGE_URL =
  'https://github.com/nighthawk-dev/nighthawk/tree/main/plugins/official/nighthawk-webbridge';
const WEB_BRIDGE_ENTRY: PluginMarketplaceEntry = {
  ...
  description: 'Control your real browser from NightHawk — navigate, click, type, and screenshot',
};
 ...
 * to proceed with a plugin that NightHawk has not reviewed.
 */
export class PluginInstallTrustConfirmComponent extends ChoicePickerComponent {
  constructor(opts: PluginInstallTrustConfirmOptions) {
    super({
      ...
      formatHint: mutedHintLine,
      notice:
        '⚠️ This is a third-party plugin that NightHawk has not reviewed. It can bundle MCP servers, ' +
