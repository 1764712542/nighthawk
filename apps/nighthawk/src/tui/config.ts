 ...
 * nighthawk client preferences such as terminal UI and update behavior.
 */
...
export const INVALID_TUI_CONFIG_MESSAGE =
  'Invalid TUI config in ~/.nighthawk/tui.toml; using defaults.';
...
`;
  return `# ~/.nighthawk/tui.toml
# Client preferences for nighthawk.
# Agent/runtime settings stay in ~/.nighthawk/config.toml.
