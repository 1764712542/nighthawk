...
export const CHANGELOG_URL = 'https://1764712542.github.io/nighthawk/en/release-notes/changelog.html';
...
function renderInstallPrompt(
  ...
  const lines = [
    chalk.hex(UPDATE_PROMPT_PRIMARY).bold('NightHawk Update Available'),
