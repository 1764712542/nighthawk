/**
 * V2 config.toml validation for `nighthawk doctor`.
 *
...
import { collectKeyDeprecations } from '@nighthawk/agent-core-v2/app/config/deprecations';
import {
  camelToSnake,
  describeTomlSyntaxError,
  isPlainObject,
  transformTomlData,
} from '@nighthawk/agent-core-v2/app/config/toml';
 ...
 * `NighthawkConfigValidationIssue` list), so the doctor formatter renders v2
