/**
 * Shared helpers for `nighthawk web` and its subcommands.
 *
...
import type { ServerLogLevel } from '@nighthawk/kap-server';
...
/** Filename (under NIGHTHAWK_HOME) of the persistent server bearer token. */
 ...
 * is the CLI's own NIGHTHAWK_HOME resolution (`getDataDir()`).
 *
