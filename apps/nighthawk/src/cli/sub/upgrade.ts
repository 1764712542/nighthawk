...
import { track as trackTelemetry, type TelemetryProperties } from '@nighthawk/telemetry';
...
export async function handleUpgrade(
  ...
  if (target === null) {
    ...
    deps.stdout.write(`NightHawk is already up to date (${formatDisplayVersion(currentVersion)}).\n`);
    return 0;
  }
