...
export { AGENT_WIRE_PROTOCOL_VERSION } from '@nighthawk/agent-core';
export type { Message, ContentPart, ToolCall, TokenUsage } from '@nighthawk/kosong';
 ...
 * because the manifest comes from another machine / nighthawk version.
 */
