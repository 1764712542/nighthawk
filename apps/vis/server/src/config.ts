...
/** Resolve NIGHTHAWK_HOME (env > ~/.nighthawk). */
export function resolveNighthawkHome(): string {
  const envHome = process.env['NIGHTHAWK_HOME'];
...
export const NIGHTHAWK_HOME: string = resolveNighthawkHome();
