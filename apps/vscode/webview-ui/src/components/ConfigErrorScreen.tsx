    ...
    <>
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Sign in with a NightHawk account, or configure a provider and model in your shared NightHawk <code className="bg-muted px-1 rounded">config.toml</code>.
        </p>
      </div>
      ...
      <div className="bg-muted/50 rounded-lg p-4 text-left space-y-2">
        <div className="flex items-center gap-2 text-xs font-medium">
          ...
          Shared NightHawk configuration
        </div>
        <p className="text-xs text-muted-foreground">
          VS Code and the terminal UI use the same NightHawk home, configuration, credentials, and sessions.
        </p>
      </div>
    ...
    return (
      <div className="h-full flex items-center justify-center p-6">
        <div className="text-center space-y-4">
          <NighthawkMascot className="h-10 mx-auto opacity-50" />
          <div className="inline-flex items-center gap-2 text-muted-foreground">
            <IconLoader2 className="size-4 animate-spin" />
            <span className="text-sm">Starting NightHawk...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="h-full flex items-center justify-center p-6">
        <div className="max-w-sm text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Open a folder to start using NightHawk.</p>
          </div>
          <Button
            onClick={() => {
      ...
      <div className="max-w-sm mx-auto text-center space-y-6">
        ...
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 text-red-500">
            <IconAlertTriangle className="size-5" />
            <span className="text-sm font-medium">NightHawk could not start</span>
          </div>
          <p className="text-xs text-muted-foreground">Check the error below. Full diagnostics are available in the NightHawk output channel.</p>
        </div>
