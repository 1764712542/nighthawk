...
import { NighthawkMascot } from "./NighthawkMascot";
...
export function LoginScreen({ onLoginSuccess, onSkip }: LoginScreenProps) {
  ...
  const handleSubscribe = () => {
    ...
    // (`https://github.com/1764712542/nighthawk` for overseas logins). The webview cannot
    // resolve the region itself — @nighthawk/nighthawk-oauth is not a
    ...
    window.open("https://github.com/1764712542/nighthawk", "_blank");
    ...
    return (
      <div className="h-full flex items-center justify-center p-6">
        <div className="max-w-sm w-full text-center space-y-6">
          <NighthawkMascot className="h-12 mx-auto" />
    ...
    <>
      <div className="h-full flex items-center justify-center p-6">
        <div className="max-w-sm w-full text-center space-y-6">
          <NighthawkMascot className="h-12 mx-auto" />
          <div className="space-y-2">
            <h1 className="text-lg font-semibold">Welcome to NightHawk</h1>
            <div className="text-left space-y-2">
              <p className="text-xs leading-5">Use NightHawk with your NightHawk account subscription or your existing API setup.</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            <div className="text-left space-y-1">
              ...
              >
                Sign in with NightHawk Account
              </Button>
              <p className="text-[11px] text-muted-foreground leading-4">Use your NightHawk account and NightHawk subscription.</p>
            </div>
      ...
      <AlertDialog open={showSubscribeDialog} onOpenChange={setShowSubscribeDialog}>
        <AlertDialogContent size="sm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Your account does not have an active NightHawk subscription. Please subscribe to continue using NightHawk with your account.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
