 ...
 */
export class NighthawkWebviewProvider implements vscode.WebviewViewProvider {
  ...
  createPanel(): vscode.WebviewPanel {
    ...
    const panel = vscode.window.createWebviewPanel("nighthawkPanel", "NightHawk", vscode.ViewColumn.One, {
      enableScripts: true,
