...
export const ERROR_MESSAGES: Record<string, string> = {
  // Pre-flight
  [LEGACY.CLI_NOT_FOUND]: "NightHawk CLI not found.",
  [LEGACY.SPAWN_FAILED]: "Failed to start NightHawk CLI.",
  [LEGACY.ALREADY_STARTED]: "A session is already running.",
  [LEGACY.STDIN_NOT_WRITABLE]: "Failed to communicate with NightHawk CLI.",
  ...
  "config.invalid": "NightHawk configuration is invalid.",
