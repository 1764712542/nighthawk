...
export const Methods = {
  ...
  GetNighthawkSessions: "getNighthawkSessions",
  GetAllNighthawkSessions: "getAllNighthawkSessions",
  GetRegisteredWorkDirs: "getRegisteredWorkDirs",
  SetWorkDir: "setWorkDir",
  BrowseWorkDir: "browseWorkDir",
  LoadNighthawkSessionHistory: "loadNighthawkSessionHistory",
  DeleteNighthawkSession: "deleteNighthawkSession",
  ForkNighthawkSession: "forkNighthawkSession",
...
function validateParams(method: RpcMethod, params: unknown): boolean {
  switch (method) {
    ...
    case Methods.GetNighthawkSessions:
    case Methods.GetAllNighthawkSessions:
    ...
    case Methods.LoadNighthawkSessionHistory:
      return hasNonEmptyString(params, "nighthawkSessionId");
    case Methods.DeleteNighthawkSession:
      return hasNonEmptyString(params, "sessionId");
    case Methods.ForkNighthawkSession:
      return isPlainObject(params)
