 ...
 * NIGHTHAWK_LEGACY_FLAG override the setting, and ignore non-truthy env values.
 * Wiring: the real VSCodeSettings module; the vscode configuration store is a
 * mutable in-memory fake.
 * Run: pnpm --filter nighthawk exec vitest run test/vscode-settings.test.ts
 */
...
describe("VSCodeSettings.useAgentCoreV1", () => {
  it("reads the nighthawk.useAgentCoreV1 setting", () => {
