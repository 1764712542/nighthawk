...
import { IAgentPermissionRulesService } from '@nighthawk/agent-core-v2/agent/permissionRules/permissionRules';
...
import { IAgentSwarmService } from '@nighthawk/agent-core-v2/features/swarm/agent/swarm';
import { IAgentTaskService } from '@nighthawk/agent-core-v2/agent/task/task';
import { IAgentToolRegistryService } from '@nighthawk/agent-core-v2/agent/toolRegistry/toolRegistry';
import { IAuthSummaryService } from '@nighthawk/agent-core-v2/app/auth/auth';
...
import { ISessionInitService } from '@nighthawk/agent-core-v2/features/sessionInit/sessionInit';
import { ISessionMetadata } from '@nighthawk/agent-core-v2/session/sessionMetadata/sessionMetadata';
import { ISessionWorkspaceContext } from '@nighthawk/agent-core-v2/session/workspaceContext/workspaceContext';
